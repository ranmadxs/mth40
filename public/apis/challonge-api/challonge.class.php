...
$challongeAPI = new ChallongeAPI("blFKNnvFaySPiWbTKkCUSdoxvf0WieaMrcWsMztX");
$params["state"] = "pending";

$tournaments = $challongeAPI->getTournaments($params);

dpr($tournaments->tournament);
dpr($tournaments);
//dpr($tournaments->SimpleXMLElement["tournament"]);
echo "XDD";
?>
